...
var followObjectsMain = function (input) {
  // Attempt the Follow Along ex  // Draw 2 cards from the top of the deck
...
var highestCardsMain = function (input) {
  ...
  // Construct an output string to communicate which cards were drawn
  var myOutputValue = `Computer 1st Card: ${computerCardOne.name} of ${computerCardOne.suit} <br> Computer 2nd Card: ${computerCardTwo.name} of ${computerCardTwo.suit} <br><br> Player 1st Card: ${playerCardOne.name} of ${playerCardOne.suit} <br> Player 2nd Card: ${playerCardTwo.name} of ${playerCardTwo.suit}`;

  if (
    computerCardOne.rank > playerCardOne.rank &&
    computerCardOne.rank > playerCardTwo.rank
  ) {
    myOutputValue += "<br><br> Computer Wins";
  } else if (
    computerCardTwo.rank > playerCardOne.rank &&
    computerCardTwo.rank > playerCardTwo.rank
  ) {
    myOutputValue += "<br><br> Computer Wins";
  } else if (
    playerCardOne.rank > computerCardOne.rank &&
    playerCardOne.rank > computerCardTwo.rank
  ) {
    myOutputValue += "<br><br> Player Wins";
  } else if (
    playerCardTwo.rank > computerCardOne.rank &&
    playerCardTwo.rank > computerCardTwo.rank
  ) {
    myOutputValue += "<br><br> Player Wins";
  } else {
